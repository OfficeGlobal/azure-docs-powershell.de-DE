...
* Bibliothek „Common.Strategy“ aktualisiert, um überprüfen zu können, ob die aktuelle Konfiguration für eine Ressource mit der Zielressource kompatibel ist. Standard ist immer „true“, einzelne Ressourcen können den Standard überschreiben.
* ps1xml-Typen zu „Common.Storage“ hinzugefügt

#### <a name="azurestorage"></a>Azure.Storage
* Unterstützung des Abrufs von Speicherkontext von „DefaultProfile“
