...
In dieser Dokumentation wird das neue Az-Modul für Azure PowerShell beschrieben. Dieses neue Modul wurde von Grund auf in .NET Standard geschrieben. Bei Verwendung von .NET Standard kann Azure PowerShell unter PowerShell 5 auf Windows oder PowerShell 6 auf einer beliebigen Plattform ausgeführt werden. Das Az-Modul ist jetzt die bevorzugte Vorgehensweise für die Interaktion mit Azure über PowerShell.
...
Sie können Azure PowerShell auf PowerShell 5.1 oder höher unter Windows und PowerShell 6 auf jeder Plattform installieren oder in Azure Cloud Shell ausführen.
...
* [PowerShell Basics: (Part 1) Getting Started with PowerShell (PowerShell-Grundlagen – Teil 1: Erste Schritte mit PowerShell)](https://channel9.msdn.com/Blogs/Taste-of-Premier/PowerShellBasicsPart1)
