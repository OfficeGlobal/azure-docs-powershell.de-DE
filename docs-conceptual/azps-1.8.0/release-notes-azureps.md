...
#### <a name="azcdn"></a><span data-ttu-id="2a4f1-114">Az.Cdn</span><span class="sxs-lookup"><span data-stu-id="2a4f1-114">Az.Cdn</span></span>
...
#### <a name="azeventhub"></a><span data-ttu-id="2a4f1-128">Az.EventHub</span><span class="sxs-lookup"><span data-stu-id="2a4f1-128">Az.EventHub</span></span>
...
#### <a name="azmonitor"></a><span data-ttu-id="2a4f1-141">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="2a4f1-141">Az.Monitor</span></span>
  * <span data-ttu-id="2a4f1-142">Neue Cmdlets für metrikbasierte GenV2-Warnungsregel (nicht klassisch)</span><span class="sxs-lookup"><span data-stu-id="2a4f1-142">New cmdlets for GenV2(non classic) metric-based alert rule</span></span>
      ...
      - <span data-ttu-id="2a4f1-147">Add-AzMetricAlertRuleV2</span><span class="sxs-lookup"><span data-stu-id="2a4f1-147">Add-AzMetricAlertRuleV2</span></span>
...
#### <a name="azrediscache"></a><span data-ttu-id="2a4f1-163">Az.RedisCache</span><span class="sxs-lookup"><span data-stu-id="2a4f1-163">Az.RedisCache</span></span>
...
## <a name="170---april-2019"></a><span data-ttu-id="2a4f1-180">1.7.0: April 2019</span><span class="sxs-lookup"><span data-stu-id="2a4f1-180">1.7.0 - April 2019</span></span>
...
#### <a name="azautomation"></a><span data-ttu-id="2a4f1-194">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="2a4f1-194">Az.Automation</span></span>
...
* <span data-ttu-id="2a4f1-211">Switch-Parameter „-IgnoreDynamicParameters“ zu Bereitstellungs-Cmdlets hinzugefügt, um Aufforderung in Skript- und Auftragsszenarien zu überspringen</span><span class="sxs-lookup"><span data-stu-id="2a4f1-211">Add '-IgnoreDynamicParameters' switch parameter to set of deployment cmdlets to skip prompt in script and job scenarios</span></span>
...
#### <a name="azrecoveryservices"></a><span data-ttu-id="2a4f1-250">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="2a4f1-250">Az.RecoveryServices</span></span>
...
## <a name="150---march-2019"></a><span data-ttu-id="2a4f1-268">1.5.0: März 2019</span><span class="sxs-lookup"><span data-stu-id="2a4f1-268">1.5.0 - March 2019</span></span>
...
#### <a name="aznetwork"></a><span data-ttu-id="2a4f1-284">Az.Network</span><span class="sxs-lookup"><span data-stu-id="2a4f1-284">Az.Network</span></span>
...
#### <a name="azstorage"></a><span data-ttu-id="2a4f1-301">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="2a4f1-301">Az.Storage</span></span>
...
#### <a name="azdatalakestore"></a><span data-ttu-id="2a4f1-317">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="2a4f1-317">Az.DataLakeStore</span></span>
...
#### <a name="azmonitor"></a><span data-ttu-id="2a4f1-337">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="2a4f1-337">Az.Monitor</span></span>
...
#### <a name="azwebsites"></a><span data-ttu-id="2a4f1-353">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="2a4f1-353">Az.Websites</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="2a4f1-371">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="2a4f1-371">Az.Sql</span></span>
...
#### <a name="azaks"></a><span data-ttu-id="2a4f1-387">Az.Aks</span><span class="sxs-lookup"><span data-stu-id="2a4f1-387">Az.Aks</span></span>
...
#### <a name="aziothub"></a><span data-ttu-id="2a4f1-406">Az.IotHub</span><span class="sxs-lookup"><span data-stu-id="2a4f1-406">Az.IotHub</span></span>
...
* <span data-ttu-id="2a4f1-424">Fehler behoben beim Hinzufügen eines Cluster-/Anwendungszertifikats ausschließlich zu VM Scale Sets, die zum Cluster gehören, indem die Cluster-ID in der Erweiterung überprüft wird.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-424">Fix add cluster/application certificate to only add to VM Scale Sets that correspond to the cluster by checking cluster id in the extension.</span></span>
...
## <a name="110---january-2019"></a><span data-ttu-id="2a4f1-443">1.1.0 – Januar 2019</span><span class="sxs-lookup"><span data-stu-id="2a4f1-443">1.1.0 - January 2019</span></span>
...
* <span data-ttu-id="2a4f1-455">Aktualisierung der folgenden Cmdlets zur Unterstützung des neuen Szenarios in der API-Version 2019-01-01</span><span class="sxs-lookup"><span data-stu-id="2a4f1-455">Update the following cmdlets to support new scenario in 2019-01-01 API version</span></span>
    ...
    - <span data-ttu-id="2a4f1-460">Update-AzureRmEventGridSubscription: Neue optionale Parameter zum Angeben folgender Werte hinzugefügt:</span><span class="sxs-lookup"><span data-stu-id="2a4f1-460">Update-AzureRmEventGridSubscription: Add new optional parameters for specifying:</span></span>
        ...
        - <span data-ttu-id="2a4f1-463">Endpunkt für unzustellbare Nachrichten</span><span class="sxs-lookup"><span data-stu-id="2a4f1-463">Dead letter endpoint.</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="2a4f1-470">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="2a4f1-470">Az.Resources</span></span>
* <span data-ttu-id="2a4f1-471">Problem mit dem Parametersatz bei Angabe der Parameter „-ODataQuery“ und „-ResourceId“ für „Get-AzResource“ behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-471">Fix parameter set issue when providing '-ODataQuery' and '-ResourceId' parameters for 'Get-AzResource'</span></span>
    - <span data-ttu-id="2a4f1-472">Weitere Informationen finden Sie hier: https://github.com/Azure/azure-powershell/issues/7875</span><span class="sxs-lookup"><span data-stu-id="2a4f1-472">More information here: https://github.com/Azure/azure-powershell/issues/7875</span></span>
* <span data-ttu-id="2a4f1-473">Behandlung des Parameters „-Custom“ in „New/Set-AzPolicyDefinition“ korrigiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-473">Fix handling of the -Custom parameter in New/Set-AzPolicyDefinition</span></span>
* <span data-ttu-id="2a4f1-474">Tippfehler in der Dokumentation für „New-AzDeployment“ korrigiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-474">Fix typo in New-AzDeployment documentation</span></span>
* <span data-ttu-id="2a4f1-475">Parameter „-MailNickname“ als obligatorisch festgelegt für „New-AzADUser“</span><span class="sxs-lookup"><span data-stu-id="2a4f1-475">Made '-MailNickname' parameter mandatory for 'New-AzADUser'</span></span>
    - <span data-ttu-id="2a4f1-476">Weitere Informationen finden Sie hier: https://github.com/Azure/azure-powershell/issues/8220</span><span class="sxs-lookup"><span data-stu-id="2a4f1-476">More information here: https://github.com/Azure/azure-powershell/issues/8220</span></span>

#### <a name="azsignalr"></a><span data-ttu-id="2a4f1-477">Az.SignalR</span><span class="sxs-lookup"><span data-stu-id="2a4f1-477">Az.SignalR</span></span>
* <span data-ttu-id="2a4f1-478">Problem mit der Abwärtskompatibilität beim Az.Accounts-Modul behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-478">Fix backward compatibility issue with Az.Accounts module</span></span>

#### <a name="azsql"></a><span data-ttu-id="2a4f1-479">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="2a4f1-479">Az.Sql</span></span>
* <span data-ttu-id="2a4f1-480">Abhängigkeit des Speicherverwaltungsclients zur allgemeinen SDK-Implementierung konvertiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-480">Converted the Storage management client dependency to the common SDK implementation.</span></span>

#### <a name="azstorage"></a><span data-ttu-id="2a4f1-481">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="2a4f1-481">Az.Storage</span></span>
* <span data-ttu-id="2a4f1-482">Festlegung des „StorageAccountName“ des Speicherkontexts als tatsächlichen Namen des Speicherkontos, wenn dieser mit „SAS-Token“, „OAuth“ oder „Anonym“ erstellt wird</span><span class="sxs-lookup"><span data-stu-id="2a4f1-482">Set the StorageAccountName of Storage context as the real Storage Account Name, when it's created with Sas Token, OAuth or Anonymous</span></span>
    - <span data-ttu-id="2a4f1-483">New-AzStorageContext</span><span class="sxs-lookup"><span data-stu-id="2a4f1-483">New-AzStorageContext</span></span>
* <span data-ttu-id="2a4f1-484">Erstellen von SAS-Token des Blob-Momentaufnahmeobjekts mit dem Parameter „-FullUri“, Festlegung des zurückgegebenen URI als Momentaufnahme-URI</span><span class="sxs-lookup"><span data-stu-id="2a4f1-484">Create Sas Token of Blob Snapshot Object with '-FullUri' parameter, fix the returned Uri to be the sanpshot Uri</span></span>
    - <span data-ttu-id="2a4f1-485">New-AzStorageBlobSASToken</span><span class="sxs-lookup"><span data-stu-id="2a4f1-485">New-AzStorageBlobSASToken</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="2a4f1-486">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="2a4f1-486">Az.Websites</span></span>
* <span data-ttu-id="2a4f1-487">Fehler bei der Datumsanalyse in „Get-AzDeletedWebApp“ behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-487">Fixed a date parsing bug in 'Get-AzDeletedWebApp'</span></span>
* <span data-ttu-id="2a4f1-488">Problem mit der Abwärtskompatibilität beim Az.Accounts-Modul behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-488">Fix backward compatibility issue with Az.Accounts module</span></span>

## <a name="100---december-2018"></a><span data-ttu-id="2a4f1-489">1.0.0 – Dezember 2018</span><span class="sxs-lookup"><span data-stu-id="2a4f1-489">1.0.0 - December 2018</span></span>
### <a name="general"></a><span data-ttu-id="2a4f1-490">Allgemein</span><span class="sxs-lookup"><span data-stu-id="2a4f1-490">General</span></span>

- <span data-ttu-id="2a4f1-491">Allgemeine Verfügbarkeit des Az-Moduls</span><span class="sxs-lookup"><span data-stu-id="2a4f1-491">General Availability of Az Module</span></span>
- <span data-ttu-id="2a4f1-492">Onlinehilfe für jedes Modul</span><span class="sxs-lookup"><span data-stu-id="2a4f1-492">Online help for each module</span></span>
- <span data-ttu-id="2a4f1-493">Ausführlichere Informationen und eine Roadmap finden Sie auf der [Seite mit der Ankündigung zu Az](https://aka.ms/azps-announce).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-493">For more details and a roadmap, see the [Az Announcement page](https://aka.ms/azps-announce)</span></span>
- <span data-ttu-id="2a4f1-494">Informationen zur Migration aus AzureRM finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-494">See the [Migration Guide](https://aka.ms/azps-migration-guide) for information on migrating from AzureRM</span></span>

### <a name="azaccounts"></a><span data-ttu-id="2a4f1-495">Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="2a4f1-495">Az.Accounts</span></span>
- <span data-ttu-id="2a4f1-496">Geändert von Az.Profile</span><span class="sxs-lookup"><span data-stu-id="2a4f1-496">Changed from Az.Profile</span></span>
- <span data-ttu-id="2a4f1-497">Feste Tabellenformate für Profil- und Kontexttypen</span><span class="sxs-lookup"><span data-stu-id="2a4f1-497">Fixed table formats for profile and context types</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="2a4f1-498">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="2a4f1-498">Az.ApiManagement</span></span>
- <span data-ttu-id="2a4f1-499">Korrekturen für #7002</span><span class="sxs-lookup"><span data-stu-id="2a4f1-499">Fixes for #7002</span></span>
- <span data-ttu-id="2a4f1-500">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-500">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbatch"></a><span data-ttu-id="2a4f1-501">Az.Batch</span><span class="sxs-lookup"><span data-stu-id="2a4f1-501">Az.Batch</span></span>
- <span data-ttu-id="2a4f1-502">Möglichkeit zum Anzeigen der ausgeführten Version des Azure Batch-Knoten-Agents auf den VMs eines Pools mit der neuen `NodeAgentInformation`-Eigenschaft für `PSComputeNode` hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-502">Added the ability to see what version of the Azure Batch Node Agent is running on each of the VMs in a pool, via the new `NodeAgentInformation` property on `PSComputeNode`.</span></span>
- <span data-ttu-id="2a4f1-503">Der `Caching`-Standardwert für `PSDataDisk` lautet jetzt nicht mehr `None`, sondern `ReadWrite`.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-503">The `Caching` default for `PSDataDisk` is now `ReadWrite` instead of `None`.</span></span>
- <span data-ttu-id="2a4f1-504">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-504">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbilling"></a><span data-ttu-id="2a4f1-505">Az.Billing</span><span class="sxs-lookup"><span data-stu-id="2a4f1-505">Az.Billing</span></span>
- <span data-ttu-id="2a4f1-506">Kombination von Billing-, Consumption- und UsageAggregates-Cmdlets. Ausführliche Informationen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-506">Combines Billing, Consumption, and UsageAggregates cmdlets, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azcognitivservices"></a><span data-ttu-id="2a4f1-507">Az.CognitivServices</span><span class="sxs-lookup"><span data-stu-id="2a4f1-507">Az.CognitivServices</span></span>
- <span data-ttu-id="2a4f1-508">Vervollständigungen für SkuName und Typem für den Vorgang New-AzureRmCognitiveServicesAccount hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-508">Add completers for SkuName and Typem available on New-AzureRmCognitiveServicesAccount operation</span></span>
- <span data-ttu-id="2a4f1-509">GetSkusWithAccountParamSetName-Parametersatz aus Get-AzCognitiveServicesAccountSkus entfernt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-509">Removed GetSkusWithAccountParamSetName parameter set from Get-AzCognitiveServicesAccountSkus</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="2a4f1-510">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="2a4f1-510">Az.ContainerInstance</span></span>
- <span data-ttu-id="2a4f1-511">ManagedIdentity-Unterstützung hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-511">Added ManagedIdentity support</span></span>

### <a name="azdatalakeanalytics"></a><span data-ttu-id="2a4f1-512">Az.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="2a4f1-512">Az.DataLakeAnalytics</span></span>
- <span data-ttu-id="2a4f1-513">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-513">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="2a4f1-514">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="2a4f1-514">Az.DataLakeStore</span></span>
- <span data-ttu-id="2a4f1-515">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-515">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azmonitor"></a><span data-ttu-id="2a4f1-516">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="2a4f1-516">Az.Monitor</span></span>
- <span data-ttu-id="2a4f1-517">Az.Insights in Az.Monitor umbenannt und weitere weniger wichtige grundlegende Änderungen durchgeführt. Informationen hierzu finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-517">Renamed Az.Insights to Az.Monitor and other minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azkeyvault"></a><span data-ttu-id="2a4f1-518">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="2a4f1-518">Az.KeyVault</span></span>
- <span data-ttu-id="2a4f1-519">Veraltete PurgeDisabled-Eigenschaft aus Ausgabetypen entfernt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-519">Removed the deprecated 'PurgeDisabled' property from output types</span></span>

### <a name="azmachinelearning"></a><span data-ttu-id="2a4f1-520">Az.MachineLearning</span><span class="sxs-lookup"><span data-stu-id="2a4f1-520">Az.MachineLearning</span></span>
- <span data-ttu-id="2a4f1-521">Cmdlets des Az.MachineLearningCompute-Moduls eingebunden</span><span class="sxs-lookup"><span data-stu-id="2a4f1-521">Included cmdlets from Az.MachineLearningCompute module</span></span>

### <a name="azmedia"></a><span data-ttu-id="2a4f1-522">Az.Media</span><span class="sxs-lookup"><span data-stu-id="2a4f1-522">Az.Media</span></span>
- <span data-ttu-id="2a4f1-523">Veralteten -Tags-Alias aus New-AzMediaService entfernt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-523">Remove deprecated -Tags alias from New-AzMediaService</span></span>

### <a name="aznetwork"></a><span data-ttu-id="2a4f1-524">Az.Network</span><span class="sxs-lookup"><span data-stu-id="2a4f1-524">Az.Network</span></span>
<span data-ttu-id="2a4f1-525">Unterstützung für das Konfigurieren von RewriteRuleSets im Application Gateway hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-525">Added support for the configuring RewriteRuleSets in the Application Gateway</span></span>
    - <span data-ttu-id="2a4f1-526">Neu hinzugefügte Cmdlets:</span><span class="sxs-lookup"><span data-stu-id="2a4f1-526">New cmdlets added:</span></span>
        - <span data-ttu-id="2a4f1-527">Add-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="2a4f1-527">Add-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="2a4f1-528">Get-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="2a4f1-528">Get-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="2a4f1-529">New-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="2a4f1-529">New-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="2a4f1-530">Remove-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="2a4f1-530">Remove-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="2a4f1-531">Set-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="2a4f1-531">Set-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="2a4f1-532">New-AzureRmApplicationGatewayRewriteRule</span><span class="sxs-lookup"><span data-stu-id="2a4f1-532">New-AzureRmApplicationGatewayRewriteRule</span></span>
        - <span data-ttu-id="2a4f1-533">New-AzureRmApplicationGatewayRewriteRuleActionSet</span><span class="sxs-lookup"><span data-stu-id="2a4f1-533">New-AzureRmApplicationGatewayRewriteRuleActionSet</span></span>
        - <span data-ttu-id="2a4f1-534">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span><span class="sxs-lookup"><span data-stu-id="2a4f1-534">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span></span>
    - <span data-ttu-id="2a4f1-535">Cmdlets mit optionalem Parameter -RewriteRuleSet aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-535">Cmdlets updated with optional parameter -RewriteRuleSet</span></span>
        - <span data-ttu-id="2a4f1-536">New-AzureRmApplicationGateway</span><span class="sxs-lookup"><span data-stu-id="2a4f1-536">New-AzureRmApplicationGateway</span></span>
        - <span data-ttu-id="2a4f1-537">New-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="2a4f1-537">New-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="2a4f1-538">Add-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="2a4f1-538">Add-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="2a4f1-539">New-AzureRmApplicationGatewayPathRuleConfig</span><span class="sxs-lookup"><span data-stu-id="2a4f1-539">New-AzureRmApplicationGatewayPathRuleConfig</span></span>
        - <span data-ttu-id="2a4f1-540">Add-AzureRmApplicationGatewayUrlPathMapConfig</span><span class="sxs-lookup"><span data-stu-id="2a4f1-540">Add-AzureRmApplicationGatewayUrlPathMapConfig</span></span>
        - <span data-ttu-id="2a4f1-541">New-AzureRmApplicationGatewayUrlPathMapConfig: KeyVault-Unterstützung mithilfe von Identität zum Application Gateway hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-541">New-AzureRmApplicationGatewayUrlPathMapConfig Added KeyVault Support to Application Gateway using Identity.</span></span>
    - <span data-ttu-id="2a4f1-542">Cmdlets mit optionalem Parameter aktualisiert: -KeyVaultSecretId, -KeyVaultSecret</span><span class="sxs-lookup"><span data-stu-id="2a4f1-542">Cmdlets updated with optonal parameter -KeyVaultSecretId, -KeyVaultSecret</span></span>
        - <span data-ttu-id="2a4f1-543">Add-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="2a4f1-543">Add-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="2a4f1-544">New-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="2a4f1-544">New-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="2a4f1-545">Set-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="2a4f1-545">Set-AzApplicationGatewaySslCertificate</span></span>
    - <span data-ttu-id="2a4f1-546">Cmdlet New-AzApplicationGateway mit optionalem Parameter -UserAssignedIdentity aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-546">New-AzApplicationGateway cmdlet updated with optional parameter -UserAssignedIdentity</span></span>
- <span data-ttu-id="2a4f1-547">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-547">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azoperationalinsights"></a><span data-ttu-id="2a4f1-548">Az.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="2a4f1-548">Az.OperationalInsights</span></span>
- <span data-ttu-id="2a4f1-549">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-549">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azprofile"></a><span data-ttu-id="2a4f1-550">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="2a4f1-550">Az.Profile</span></span>
- <span data-ttu-id="2a4f1-551">Modulnamen in Az.Accounts geändert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-551">Changed module name to Az.Accounts</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="2a4f1-552">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="2a4f1-552">Az.RecoveryServices</span></span>
- <span data-ttu-id="2a4f1-553">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-553">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azresources"></a><span data-ttu-id="2a4f1-554">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="2a4f1-554">Az.Resources</span></span>
- <span data-ttu-id="2a4f1-555">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-555">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="2a4f1-556">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="2a4f1-556">Az.ServiceFabric</span></span>
- <span data-ttu-id="2a4f1-557">Unterstützung für das Angeben des Zertifikats anhand des allgemeinen Namens und Fingerabdrucks</span><span class="sxs-lookup"><span data-stu-id="2a4f1-557">Support specfying certificate by common name and thumbprint</span></span>
- <span data-ttu-id="2a4f1-558">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-558">Mnor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azsignalr"></a><span data-ttu-id="2a4f1-559">Az.SIgnalR</span><span class="sxs-lookup"><span data-stu-id="2a4f1-559">Az.SIgnalR</span></span>
- <span data-ttu-id="2a4f1-560">Allgemeine Verfügbarkeit für PowerShell-Cmdlets für SIgnalR</span><span class="sxs-lookup"><span data-stu-id="2a4f1-560">General Availability for PowerShell cmdlets for SIgnalR</span></span>

### <a name="azsql"></a><span data-ttu-id="2a4f1-561">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="2a4f1-561">Az.Sql</span></span>
- <span data-ttu-id="2a4f1-562">Neue Erkennungstypen Data_Exfiltration und Unsafe_Action zu Cmdlets für Bedrohungserkennung hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-562">Added new Data_Exfiltration and Unsafe_Action detection types to Threat Detection's cmdlets</span></span>
- <span data-ttu-id="2a4f1-563">Dokumentationsbeispiele für Cmdlets für SQL-Überwachung aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-563">Updated documentation examples for Sql Auditing cmdlets</span></span>
- <span data-ttu-id="2a4f1-564">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-564">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azstorage"></a><span data-ttu-id="2a4f1-565">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="2a4f1-565">Az.Storage</span></span>
- <span data-ttu-id="2a4f1-566">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-566">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azwebsites"></a><span data-ttu-id="2a4f1-567">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="2a4f1-567">Az.Websites</span></span>
- <span data-ttu-id="2a4f1-568">Informationen zu weniger wichtigen grundlegenden Änderungen finden Sie im [Migrationsleitfaden](https://aka.ms/azps-migration-guide).</span><span class="sxs-lookup"><span data-stu-id="2a4f1-568">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

## <a name="070---december-2018"></a><span data-ttu-id="2a4f1-569">0.7.0 – Dezember 2018</span><span class="sxs-lookup"><span data-stu-id="2a4f1-569">0.7.0 - December 2018</span></span>

### <a name="general"></a><span data-ttu-id="2a4f1-570">Allgemein</span><span class="sxs-lookup"><span data-stu-id="2a4f1-570">General</span></span>

* <span data-ttu-id="2a4f1-571">Geringe Änderungen für anstehenden Übergang von AzureRM zu Az</span><span class="sxs-lookup"><span data-stu-id="2a4f1-571">Minor changes for upcoming AzureRM to Az transition</span></span>

### <a name="azcompute"></a><span data-ttu-id="2a4f1-572">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="2a4f1-572">Az.Compute</span></span>

* <span data-ttu-id="2a4f1-573">Unterstützung für UltraSSD und Katalogimages in einfachen Parametersätzen für `New-AzVm(ss)`-Cmdlets hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-573">Add support for UltraSSD and Gallery Images in the simple param sets for `New-AzVm(ss)` cmdlets.</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="2a4f1-574">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="2a4f1-574">Az.DataLakeStore</span></span>

* <span data-ttu-id="2a4f1-575">Nachgestellten Schrägstrich für die Domäne des ADLS-Kontos korrigiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-575">Fix the trailing slash of the domain of adls account</span></span>

### <a name="azfrontdoor"></a><span data-ttu-id="2a4f1-576">Az.FrontDoor</span><span class="sxs-lookup"><span data-stu-id="2a4f1-576">Az.FrontDoor</span></span>

* <span data-ttu-id="2a4f1-577">Einige fehlerhafte Links behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-577">Fixed some broken links</span></span>
    - <span data-ttu-id="2a4f1-578">In den Artikeln zu New-AzureRmFrontDoor und Set-AzureRmFrontDoor den Artikel-Link zum Cmdlet „New-AzureRmFrontDoorHealthProbeSettingObject“ korrigiert.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-578">In the New-AzureRmFrontDoor and Set-AzureRmFrontDoor articles, fixed the link to the New-AzureRmFrontDoorHealthProbeSettingObject cmdlet article.</span></span>
    - <span data-ttu-id="2a4f1-579">Im Artikel zu New-AzureRmFrontDoorManagedRuleObject den Artikel-Link zum Cmdlet „New-AzureRmFrontDoorRuleGroupOverrideObject“ korrigiert.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-579">In the New-AzureRmFrontDoorManagedRuleObject article, fixed the link to the New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet article.</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="2a4f1-580">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="2a4f1-580">Az.RecoveryServices</span></span>

* <span data-ttu-id="2a4f1-581">Clientseitige Validierungen für Wiederherstellungsvorgänge von Azure-Dateifreigaben hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-581">Added client side validations for Azure File Share restore operations.</span></span>
* <span data-ttu-id="2a4f1-582">storageAccountName und storageAccountResourceGroupName für AFS-Wiederherstellung optional gemacht.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-582">Made storageAccountName and storageAccountResourceGroupName optional for afs restore.</span></span>

### <a name="azresources"></a><span data-ttu-id="2a4f1-583">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="2a4f1-583">Az.Resources</span></span>

* <span data-ttu-id="2a4f1-584">Fehlerbehebung für https://github.com/Azure/azure-powershell/issues/7679</span><span class="sxs-lookup"><span data-stu-id="2a4f1-584">Fix for https://github.com/Azure/azure-powershell/issues/7679</span></span>
    - <span data-ttu-id="2a4f1-585">Get-AzureRmRoleAssignment für die Verwendung des Abonnementbereichs aktualisiert, wenn dieser beim Anfordern von klassischen Administratoren angegeben wird.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-585">Update Get-AzureRmRoleAssignment to use the subscription scope if it is provided when requesting classic administrators.</span></span>

### <a name="azsql"></a><span data-ttu-id="2a4f1-586">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="2a4f1-586">Az.Sql</span></span>

* <span data-ttu-id="2a4f1-587">Geringe Änderungen für anstehenden Übergang von AzureRM zu Az</span><span class="sxs-lookup"><span data-stu-id="2a4f1-587">Minor changes for upcoming AzureRM to Az transition</span></span>
* <span data-ttu-id="2a4f1-588">Problem mit der Verwendung von Get-AzureRmSqlDatabaseVulnerabilityAssessment mit .NET Core behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-588">Fixed issue with using Get-AzureRmSqlDatabaseVulnerabilityAssessment with DotNet core</span></span>
* <span data-ttu-id="2a4f1-589">Dokumentation mit Hilfemeldungen zu Cmdlets für die SQL-Überwachung geändert.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-589">Modified documentation of help messages related to SQL Auditing cmdlets.</span></span>

### <a name="azstorage"></a><span data-ttu-id="2a4f1-590">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="2a4f1-590">Az.Storage</span></span>

* <span data-ttu-id="2a4f1-591">-EnableHierarchicalNamespace zu New-AzureRmStorageAccount hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-591">Add -EnableHierarchicalNamespace to New-AzureRmStorageAccount</span></span>
* <span data-ttu-id="2a4f1-592">Problem behoben, bei dem für das Copy File-Cmdlet am Ziel kein Quellkontext wiederverwendet werden kann, wenn -DestContext nicht eingegeben wird</span><span class="sxs-lookup"><span data-stu-id="2a4f1-592">Fix issue that Copy File cmdlet can't reuse source context in destination when not input -DestContext</span></span>
    - <span data-ttu-id="2a4f1-593">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="2a4f1-593">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="2a4f1-594">Unterstützung der Konfiguration von statischen Websites</span><span class="sxs-lookup"><span data-stu-id="2a4f1-594">Support Static Website configuration</span></span>
    - <span data-ttu-id="2a4f1-595">Enable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="2a4f1-595">Enable-AzureStorageStaticWebsite</span></span>
    - <span data-ttu-id="2a4f1-596">Disable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="2a4f1-596">Disable-AzureStorageStaticWebsite</span></span>

### <a name="azwebsites"></a><span data-ttu-id="2a4f1-597">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="2a4f1-597">Az.Websites</span></span>

* <span data-ttu-id="2a4f1-598">Set-AzureRmWebApp und Set-AzureRmWebAppSlot</span><span class="sxs-lookup"><span data-stu-id="2a4f1-598">Set-AzureRmWebApp and Set-AzureRmWebAppSlot</span></span> 
    - <span data-ttu-id="2a4f1-599">Neuen Parameter (-AzureStoragePath) zum Angeben von Azure Storage-Pfaden hinzugefügt, die in Windows- und Linux-Container-Apps bereitgestellt werden sollen.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-599">New parameter (-AzureStoragePath) added to specify Azure Storage paths to be mounted in Windows and Linux container apps.</span></span> <span data-ttu-id="2a4f1-600">Verwenden Sie die Ausgabe des neuen Cmdlets New-AzureRmWebAppAzureStoragePath als Parameter zum Festlegen der Azure Storage-Pfade.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-600">Use the output of the new cmdlet New-AzureRmWebAppAzureStoragePath as a parameter to set the Azure Storage paths.</span></span>

## <a name="061---november-2018"></a><span data-ttu-id="2a4f1-601">0.6.1 – November 2018</span><span class="sxs-lookup"><span data-stu-id="2a4f1-601">0.6.1 - November 2018</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="2a4f1-602">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="2a4f1-602">Az.ApiManagement</span></span>
* <span data-ttu-id="2a4f1-603">Abhängigkeiten für Typzuordnungsproblem aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-603">Update dependencies for type mapping issue</span></span>

### <a name="azautomation"></a><span data-ttu-id="2a4f1-604">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="2a4f1-604">Az.Automation</span></span>
* <span data-ttu-id="2a4f1-605">Swagger-basierte Azure Automation-Cmdlets</span><span class="sxs-lookup"><span data-stu-id="2a4f1-605">Swagger based Azure Automation cmdlets</span></span>
* <span data-ttu-id="2a4f1-606">Cmdlets zur Updateverwaltung hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-606">Added Update Management cmdlets</span></span>
* <span data-ttu-id="2a4f1-607">Cmdlets zur Quellcodeverwaltung hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-607">Added Source Control cmdlets</span></span>
* <span data-ttu-id="2a4f1-608">Cmdlet „Remove-AzureRmAutomationHybridWorkerGroup“ hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-608">Added Remove-AzureRmAutomationHybridWorkerGroup cmdlet</span></span>
* <span data-ttu-id="2a4f1-609">DSC-Befehl für die Knotenregistrierung korrigiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-609">Fixed the DSC Register Node command</span></span>

### <a name="azcompute"></a><span data-ttu-id="2a4f1-610">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="2a4f1-610">Az.Compute</span></span>
* <span data-ttu-id="2a4f1-611">Identitätsproblem für SystemAssigned-Identität korrigiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-611">Fixed identity issue for SystemAssigned identity</span></span>
* <span data-ttu-id="2a4f1-612">Abhängigkeiten für Typzuordnungsproblem aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-612">Update dependencies for type mapping issue</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="2a4f1-613">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="2a4f1-613">Az.ContainerInstance</span></span>
* <span data-ttu-id="2a4f1-614">Abhängigkeiten für Typzuordnungsproblem aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-614">Update dependencies for type mapping issue</span></span>

### <a name="azmarketplaceordering"></a><span data-ttu-id="2a4f1-615">Az.MarketplaceOrdering</span><span class="sxs-lookup"><span data-stu-id="2a4f1-615">Az.MarketplaceOrdering</span></span>
* <span data-ttu-id="2a4f1-616">Beschreibung der Beispiele für Marketplace-Cmdlets aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-616">update the examples description for marketplace cmdlets</span></span>

### <a name="aznetwork"></a><span data-ttu-id="2a4f1-617">Az.Network</span><span class="sxs-lookup"><span data-stu-id="2a4f1-617">Az.Network</span></span>
* <span data-ttu-id="2a4f1-618">Folgende Cmdlets hinzugefügt: New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span><span class="sxs-lookup"><span data-stu-id="2a4f1-618">Added cmdlet New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span></span>
* <span data-ttu-id="2a4f1-619">ICMP wieder unterstützten AzureFirewall-Netzwerkprotokollen hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-619">Added ICMP back to supported AzureFirewall Network Protocols</span></span>
* <span data-ttu-id="2a4f1-620">Cmdlet „Test-AzureRmNetworkWatcherConnectivity“ aktualisiert und Überprüfung für Ziel-ID, Adresse und Port hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-620">Update cmdlet Test-AzureRmNetworkWatcherConnectivity, add validation on destination id, address and port.</span></span> 
* <span data-ttu-id="2a4f1-621">Probleme mit Arbeitsspeicherauslastung in der VirtualNetwork-Zuordnung behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-621">Fix issues with memory usage in VirtualNetwork map</span></span>

### <a name="azrecoveryservicesbackup"></a><span data-ttu-id="2a4f1-622">Az.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="2a4f1-622">Az.RecoveryServices.Backup</span></span>
* <span data-ttu-id="2a4f1-623">Problem beim Ändern der Richtlinie für eine geschützte Dateifreigabe behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-623">Fix for modifying policy for a protected file share.</span></span>
* <span data-ttu-id="2a4f1-624">Richtlinienzeitzone in Großschreibung geändert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-624">Converted policy timezone to uppercase.</span></span>

### <a name="azrecoveryservicessiterecovery"></a><span data-ttu-id="2a4f1-625">Az.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="2a4f1-625">Az.RecoveryServices.SiteRecovery</span></span>
* <span data-ttu-id="2a4f1-626">Korrigiertes Beispiel in „New-AzureRmRecoveryServicesAsrProtectableItem“</span><span class="sxs-lookup"><span data-stu-id="2a4f1-626">Corrected example in New-AzureRmRecoveryServicesAsrProtectableItem</span></span>
* <span data-ttu-id="2a4f1-627">Abhängigkeiten für Typzuordnungsproblem aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-627">Update dependencies for type mapping issue</span></span>

### <a name="azrelay"></a><span data-ttu-id="2a4f1-628">Az.Relay</span><span class="sxs-lookup"><span data-stu-id="2a4f1-628">Az.Relay</span></span>
* <span data-ttu-id="2a4f1-629">Optionaler Parameter „-KeyValue“ zu Cmdlet „New-AzureRmRelayKey“ hinzugefügt, der dem Benutzer das Angeben von „KeyValue“ ermöglicht</span><span class="sxs-lookup"><span data-stu-id="2a4f1-629">Added optional Parameter -KeyValue to New-AzureRmRelayKey cmdlet, which enables user to provide KeyValue.</span></span>

### <a name="azresources"></a><span data-ttu-id="2a4f1-630">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="2a4f1-630">Az.Resources</span></span>
* <span data-ttu-id="2a4f1-631">Hilfedokumentation für ressourcenidentitätsbezogene Parameter in `New-AzureRmPolicyAssignment` und `Set-AzureRmPolicyAssignment` aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-631">Update help documentation for resource identity related parameters in `New-AzureRmPolicyAssignment` and `Set-AzureRmPolicyAssignment`</span></span>
* <span data-ttu-id="2a4f1-632">Beispiel für „New-AzureRmPolicyDefinition“ hinzugefügt, das „-Metadata“ nutzt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-632">Add an example for New-AzureRmPolicyDefinition that uses -Metadata</span></span>
* <span data-ttu-id="2a4f1-633">Korrektur, um Beibehaltung von Groß-/Kleinschreibung in Tagschlüsseln in „NetStandard“ zu ermöglichen: #7678 #7703</span><span class="sxs-lookup"><span data-stu-id="2a4f1-633">Fix to allow case preservation in Tag keys in NetStandard: #7678 #7703</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="2a4f1-634">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="2a4f1-634">Az.ServiceFabric</span></span>
* <span data-ttu-id="2a4f1-635">Benachrichtigung über veraltete Elemente für anstehende wichtige Änderungen hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-635">Add deprecation messages for upcoming breaking changes</span></span>

### <a name="azsql"></a><span data-ttu-id="2a4f1-636">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="2a4f1-636">Az.Sql</span></span>
* <span data-ttu-id="2a4f1-637">Neue Cmdlets für CRUD-Vorgänge in verwalteten Azure SQL-Datenbank-Instanzen und verwalteten Azure SQL-Datenbanken hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-637">Added new cmdlets for CRUD operations on Azure Sql Database Managed Instance and Azure Sql Managed Database</span></span>
    - <span data-ttu-id="2a4f1-638">Get-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="2a4f1-638">Get-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="2a4f1-639">New-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="2a4f1-639">New-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="2a4f1-640">Set-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="2a4f1-640">Set-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="2a4f1-641">Remove-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="2a4f1-641">Remove-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="2a4f1-642">Get-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="2a4f1-642">Get-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="2a4f1-643">New-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="2a4f1-643">New-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="2a4f1-644">Restore-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="2a4f1-644">Restore-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="2a4f1-645">Remove-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="2a4f1-645">Remove-AzureRmSqlInstanceDatabase</span></span>
* <span data-ttu-id="2a4f1-646">Erweiterte Verwaltung von Überwachungsrichtlinien auf einem Server oder in einer Datenbank aktiviert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-646">Enabled Extended Auditing Policy management on a server or a database.</span></span>
    - <span data-ttu-id="2a4f1-647">Neuer Parameter (PredicateExpression) hinzugefügt, um die Filterung von Überwachungsprotokollen zu ermöglichen</span><span class="sxs-lookup"><span data-stu-id="2a4f1-647">New parameter (PredicateExpression) was added to enable filtering of audit logs.</span></span>
    - <span data-ttu-id="2a4f1-648">Cmdlets wurden angepasst, sodass sie SQL-Clients anstelle von Legacyclients verwenden.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-648">Cmdlets were modified to use SQL clients instead of Legacy clients.</span></span>
    - <span data-ttu-id="2a4f1-649">Set-AzureRmSqlServerAuditing</span><span class="sxs-lookup"><span data-stu-id="2a4f1-649">Set-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="2a4f1-650">Get-AzureRmSqlServerAuditing</span><span class="sxs-lookup"><span data-stu-id="2a4f1-650">Get-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="2a4f1-651">Set-AzureRmSqlDatabaseAuditing</span><span class="sxs-lookup"><span data-stu-id="2a4f1-651">Set-AzureRmSqlDatabaseAuditing.</span></span>
    - <span data-ttu-id="2a4f1-652">Get-AzureRmSqlDatabaseAuditing</span><span class="sxs-lookup"><span data-stu-id="2a4f1-652">Get-AzureRmSqlDatabaseAuditing.</span></span>
* <span data-ttu-id="2a4f1-653">Problem bei Verwendung von „Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings“ mit festgelegtem Parameter für den Speicherkontonamen behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-653">Fixed issue with using Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings with storage account name parameter set</span></span>

## <a name="050---november-2018"></a><span data-ttu-id="2a4f1-654">0.5.0 – November 2018</span><span class="sxs-lookup"><span data-stu-id="2a4f1-654">0.5.0 - November 2018</span></span>
#### <a name="general"></a><span data-ttu-id="2a4f1-655">Allgemein</span><span class="sxs-lookup"><span data-stu-id="2a4f1-655">General</span></span>
* <span data-ttu-id="2a4f1-656">Ressourcenvervollständigungen für viele Kern-Cmdlets hinzugefügt (diese ermöglichen das Durchlaufen von vorhandenen Ressourcennamen per TAB-TASTE, wenn Cmdlets interaktiv aufgerufen werden)</span><span class="sxs-lookup"><span data-stu-id="2a4f1-656">Added Resource Completers to many core cmdlets - these alloow you to tab through existing resource names when invoking cmdlets interactively</span></span>

#### <a name="azprofile"></a><span data-ttu-id="2a4f1-657">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="2a4f1-657">Az.Profile</span></span>
* <span data-ttu-id="2a4f1-658">Allgemeiner Code aktualisiert, sodass die aktuelle Version von „ClientRuntime“ verwendet wird</span><span class="sxs-lookup"><span data-stu-id="2a4f1-658">Update common code to use latest version of ClientRuntime</span></span>
* <span data-ttu-id="2a4f1-659">Parameter „TenantId“ im Cmdlet „Connect-AzAccount“ in „Tenant“ umbenannt und Alias für „TenantId“ hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-659">Rename param TenantId in cmdlet Connect-AzAccount to Tenant and add an alias for TenantId</span></span>
* <span data-ttu-id="2a4f1-660">Beschreibung von „TenantId“ für „Connect-AzAccount“ aktualisiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-660">Updated TenantId description for Connect-AzAccount</span></span>
* <span data-ttu-id="2a4f1-661">Fehlermeldung für fehlgeschlagene Anmeldung bei Angabe der Mandantendomäne korrigiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-661">Fix error message for failed login when providing tenant domain</span></span>
    - https://github.com/Azure/azure-powershell/issues/6936
* <span data-ttu-id="2a4f1-662">Problem in Bezug auf Kontextnamenskonflikt für Konten ohne Abonnements im Mandanten behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-662">Fix issue with context name clashing for accounts with no subscriptions in tenant</span></span>
    - https://github.com/Azure/azure-powershell/issues/7453
* <span data-ttu-id="2a4f1-663">Problem mit DataLake-Endpunkten bei Verwendung von MSI behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-663">Fix issue with DataLake endpoints when using MSI</span></span>
    - https://github.com/Azure/azure-powershell/issues/7462
* <span data-ttu-id="2a4f1-664">Problem behoben, das zur Auslösung von „Disconnect-AzAccount“ führte, wenn keine Verbindung bestand</span><span class="sxs-lookup"><span data-stu-id="2a4f1-664">Fix issue where 'Disconnect-AzAccount' would throw if not connected</span></span>
    - https://github.com/Azure/azure-powershell/issues/7167

#### <a name="azcognitiveservices"></a><span data-ttu-id="2a4f1-665">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="2a4f1-665">Az.CognitiveServices</span></span>
* <span data-ttu-id="2a4f1-666">Vorgang „Get-AzCognitiveServicesAccountSkus“ hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-666">Add Get-AzCognitiveServicesAccountSkus operation.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="2a4f1-667">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="2a4f1-667">Az.Compute</span></span>
* <span data-ttu-id="2a4f1-668">Cmdlets Add-AzVmssVMDataDisk und Remove-AzVmssVMDataDisk hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-668">Add Add-AzVmssVMDataDisk and Remove-AzVmssVMDataDisk cmdlets</span></span>
* <span data-ttu-id="2a4f1-669">„Get-AzVMImage“ zeigt „AutomaticOSUpgradeProperties“ an</span><span class="sxs-lookup"><span data-stu-id="2a4f1-669">Get-AzVMImage shows AutomaticOSUpgradeProperties</span></span>
* <span data-ttu-id="2a4f1-670">Problem behoben, aufgrund dessen die Optionswerte „SetAzVMChefExtension -BootstrapOptions“ und „-JsonAttribute“ nicht im JSON-Format festgelegt wurden</span><span class="sxs-lookup"><span data-stu-id="2a4f1-670">Fixed SetAzVMChefExtension -BootstrapOptions and -JsonAttribute option values are not setting in json format.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="2a4f1-671">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="2a4f1-671">Az.DataLakeStore</span></span>
* <span data-ttu-id="2a4f1-672">Aktualisierung des DataLake-Pakets auf 1.1.10</span><span class="sxs-lookup"><span data-stu-id="2a4f1-672">Update the DataLake package to 1.1.10.</span></span>
* <span data-ttu-id="2a4f1-673">Standardmäßige Parallelität zu Multithreadvorgängen hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-673">Add default Concurrency to multithreaded operations.</span></span>

#### <a name="azinsights"></a><span data-ttu-id="2a4f1-674">Az.Insights</span><span class="sxs-lookup"><span data-stu-id="2a4f1-674">Az.Insights</span></span>
* <span data-ttu-id="2a4f1-675">Problem Nr. 7267 behoben (Bereich für automatische Skalierung)</span><span class="sxs-lookup"><span data-stu-id="2a4f1-675">Fixed issue #7267 (Autoscale area)</span></span>
    - <span data-ttu-id="2a4f1-676">Probleme beim Erstellen einer neuen Regel für die automatische Skalierung, aufgrund derer die aufgelisteten Parameter nicht richtig festgelegt wurden (Es wurde stets der Standardwert festgelegt.)</span><span class="sxs-lookup"><span data-stu-id="2a4f1-676">Issues with creating a new autoscale rule not properly setting enumerated parameters (would always set them to the default value).</span></span>
* <span data-ttu-id="2a4f1-677">Problem Nr. 7513 behoben [Insights] „Set-AzDiagnosticSetting“ erfordert die explizite Angabe von Kategorien während der Erstellung der Einstellung.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-677">Fixed issue #7513 [Insights] Set-AzDiagnosticSetting requires explicit specification of categories during creation of setting</span></span>
    - <span data-ttu-id="2a4f1-678">Nun erfordert das Cmdlet nicht die explizite Angabe der Kategorien, die während der Erstellung aktiviert werden sollen. Das bedeutet, es funktioniert wie dokumentiert.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-678">Now the cmdlet does not require explicit indication of the categories to enable during creation, i.e. it works as it is documented</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="2a4f1-679">Az.Network</span><span class="sxs-lookup"><span data-stu-id="2a4f1-679">Az.Network</span></span>
* <span data-ttu-id="2a4f1-680">„PeeringType“ wurde geändert und ist nun ein erforderlicher Parameter für die folgenden Cmdlets:</span><span class="sxs-lookup"><span data-stu-id="2a4f1-680">Changed PeeringType to be a mandatory parameter for the following cmdlets:-</span></span>
    - <span data-ttu-id="2a4f1-681">Get-AzExpressRouteCircuitRouteTable</span><span class="sxs-lookup"><span data-stu-id="2a4f1-681">Get-AzExpressRouteCircuitRouteTable</span></span>
    - <span data-ttu-id="2a4f1-682">Get-AzExpressRouteCircuitARPTable</span><span class="sxs-lookup"><span data-stu-id="2a4f1-682">Get-AzExpressRouteCircuitARPTable</span></span>
    - <span data-ttu-id="2a4f1-683">Get-AzExpressRouteCircuitRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="2a4f1-683">Get-AzExpressRouteCircuitRouteTableSummary</span></span>
    - <span data-ttu-id="2a4f1-684">Get-AzExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="2a4f1-684">Get-AzExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="2a4f1-685">Get-AzExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="2a4f1-685">Get-AzExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="2a4f1-686">Get-AzExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="2a4f1-686">Get-AzExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azpolicyinsights"></a><span data-ttu-id="2a4f1-687">Az.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="2a4f1-687">Az.PolicyInsights</span></span>
* <span data-ttu-id="2a4f1-688">Cmdlets für Richtlinienwartung hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-688">Added policy remediation cmdlets</span></span>

#### <a name="azresources"></a><span data-ttu-id="2a4f1-689">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="2a4f1-689">Az.Resources</span></span>
* <span data-ttu-id="2a4f1-690">Fehlerbehebung für https://github.com/Azure/azure-powershell/issues/7402</span><span class="sxs-lookup"><span data-stu-id="2a4f1-690">Fix for https://github.com/Azure/azure-powershell/issues/7402</span></span>
    - <span data-ttu-id="2a4f1-691">Zulassen der Auflistung von Ressourcen mithilfe des Parameters „-ResourceId“ für „Get-AzResource“</span><span class="sxs-lookup"><span data-stu-id="2a4f1-691">Allow listing resources using the '-ResourceId' parameter for 'Get-AzResource'</span></span>

#### <a name="azservicebus"></a><span data-ttu-id="2a4f1-692">Az.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="2a4f1-692">Az.ServiceBus</span></span>
* <span data-ttu-id="2a4f1-693">Schreibgeschützte Eigenschaft „MigrationState“ zu „PSServiceBusMigrationConfigurationAttributes“ hinzugefügt, was das Ermitteln des Migrationsstatus ermöglicht</span><span class="sxs-lookup"><span data-stu-id="2a4f1-693">Added MigrationState read-only property to PSServiceBusMigrationConfigurationAttributes which will help to know the Migration state.</span></span>

#### <a name="azservicefabric"></a><span data-ttu-id="2a4f1-694">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="2a4f1-694">Az.ServiceFabric</span></span>
* <span data-ttu-id="2a4f1-695">Hinzufügen des Zertifikats zu Linux VMSS korrigiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-695">Fix add certificate to Linux Vmss.</span></span>
* <span data-ttu-id="2a4f1-696">„Add-AzServiceFabricClusterCertificate“ korrigiert</span><span class="sxs-lookup"><span data-stu-id="2a4f1-696">Fix 'Add-AzServiceFabricClusterCertificate'</span></span>
    - <span data-ttu-id="2a4f1-697">Verwenden des richtigen Fingerabdrucks aus dem neuen Zertifikat (Azure/service-fabric-issues#932)</span><span class="sxs-lookup"><span data-stu-id="2a4f1-697">Using correct thumbprint from new certificate (Azure/service-fabric-issues#932).</span></span>
    - <span data-ttu-id="2a4f1-698">Richtige Anzeige von Ausnahmen (Azure/service-fabric-issues#1054)</span><span class="sxs-lookup"><span data-stu-id="2a4f1-698">Display exception correctly (Azure/service-fabric-issues#1054).</span></span>
* <span data-ttu-id="2a4f1-699">„Update-AzServiceFabricDurability“ korrigiert, um die Clusterkonfiguration zu aktualisieren, bevor der VMSS-Vorgang „CreateOrUpdate“ gestartet wird</span><span class="sxs-lookup"><span data-stu-id="2a4f1-699">Fix 'Update-AzServiceFabricDurability' to update cluster configuration before starting Vmss CreateOrUpdate operation.</span></span>

## <a name="040---october-2018"></a><span data-ttu-id="2a4f1-700">0.4.0 – Oktober 2018</span><span class="sxs-lookup"><span data-stu-id="2a4f1-700">0.4.0 - October 2018</span></span>
#### <a name="azprofile"></a><span data-ttu-id="2a4f1-701">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="2a4f1-701">Az.Profile</span></span>
* <span data-ttu-id="2a4f1-702">Problem mit „Get-AzSubscription“ in Cloud Shell behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-702">Fix issue with Get-AzSubscription in CloudShell</span></span>
* <span data-ttu-id="2a4f1-703">Allgemeiner Code aktualisiert, sodass die aktuelle Version von „ClientRuntime“ verwendet wird</span><span class="sxs-lookup"><span data-stu-id="2a4f1-703">Update common code to use latest version of ClientRuntime</span></span>

#### <a name="azcompute"></a><span data-ttu-id="2a4f1-704">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="2a4f1-704">Az.Compute</span></span>
* <span data-ttu-id="2a4f1-705">Neue Größen zur Whitelist von VM-Größen hinzugefügt, für die bei Verwendung des einfachen Parametersatzes für „New-AzVm“ der beschleunigte Netzwerkbetrieb aktiviert wird</span><span class="sxs-lookup"><span data-stu-id="2a4f1-705">Added new sizes to the whitelist of VM sizes for which accelerated networking will be turned on when using the simple param set for 'New-AzVm'</span></span>
* <span data-ttu-id="2a4f1-706">ResourceName-Argumentvervollständigung zu allen Cmdlets hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-706">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="2a4f1-707">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="2a4f1-707">Az.DataLakeStore</span></span>
* <span data-ttu-id="2a4f1-708">Unterstützung für VNET-Regeln hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-708">Adding support for Virtual Network Rules</span></span>
    - <span data-ttu-id="2a4f1-709">Get-AzDataLakeStoreVirtualNetworkRule: Dient zum Abrufen oder Auflisten der Azure Data Lake Store-Regel für das virtuelle Netzwerk.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-709">Get-AzDataLakeStoreVirtualNetworkRule: Gets or Lists Azure Data Lake Store virtual network rule.</span></span>
    - <span data-ttu-id="2a4f1-710">Add-AzDataLakeStoreVirtualNetworkRule: Fügt dem angegebenen Data Lake Store-Konto eine Regel für das virtuelle Netzwerk hinzu.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-710">Add-AzDataLakeStoreVirtualNetworkRule: Adds a virtual network rule to the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="2a4f1-711">Set-AzDataLakeStoreVirtualNetworkRule: Ändert die angegebene Regel für das virtuelle Netzwerk in das angegebene Data Lake Store-Konto.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-711">Set-AzDataLakeStoreVirtualNetworkRule: Modifies the specified virtual network rule in the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="2a4f1-712">Remove-AzDataLakeStoreVirtualNetworkRule: Dient zum Löschen der Azure Data Lake Store-Regel für das virtuelle Netzwerk.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-712">Remove-AzDataLakeStoreVirtualNetworkRule: Deletes an Azure Data Lake Store virtual network rule.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="2a4f1-713">Az.Network</span><span class="sxs-lookup"><span data-stu-id="2a4f1-713">Az.Network</span></span>
* <span data-ttu-id="2a4f1-714">Cmdlet „Test-AzNetworkWatcherConnectivity“ aktualisiert, Protokollwert wird jetzt an Back-End übergeben.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-714">Update cmdlet Test-AzNetworkWatcherConnectivity, pass the protocol value to backend.</span></span>
* <span data-ttu-id="2a4f1-715">ResourceName-Argumentvervollständigung zu allen Cmdlets hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-715">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azresources"></a><span data-ttu-id="2a4f1-716">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="2a4f1-716">Az.Resources</span></span>
* <span data-ttu-id="2a4f1-717">Problem behoben, aufgrund dessen „Get-AzRoleDefinition“ eine unverständliche Ausnahme auslöst (wenn das Standardprofil kein Abonnement enthält und kein Bereich festgelegt ist), indem im Szenario eine aussagekräftige Ausnahme hinzugefügt wurde.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-717">Fix isssue where Get-AzRoleDefinition throws an unintelligible exception (when the default profile has no subscription in it and no scope is specified) by adding a meaningful exception in the scenario.</span></span> <span data-ttu-id="2a4f1-718">Außerdem wurde der Standardparametersatz auf „RoleDefinitionNameParameterSet“ festgelegt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-718">Also set the default param set to 'RoleDefinitionNameParameterSet'.</span></span>

## <a name="030---october-2018"></a><span data-ttu-id="2a4f1-719">0.3.0 – Oktober 2018</span><span class="sxs-lookup"><span data-stu-id="2a4f1-719">0.3.0 - October 2018</span></span>
#### <a name="azurestorage"></a><span data-ttu-id="2a4f1-720">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="2a4f1-720">Azure.Storage</span></span>
* <span data-ttu-id="2a4f1-721">Fehler beim Kopieren von Blobs/Dateien behoben, aufgrund dessen bei einem Metadatenproblem des Ziels keine Metadaten kopiert wurden</span><span class="sxs-lookup"><span data-stu-id="2a4f1-721">Fix Copy Blob/File won't copy metadata when destination has metadata issue</span></span>
    - <span data-ttu-id="2a4f1-722">Start-AzureStorageBlobCopy</span><span class="sxs-lookup"><span data-stu-id="2a4f1-722">Start-AzureStorageBlobCopy</span></span>
    - <span data-ttu-id="2a4f1-723">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="2a4f1-723">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="2a4f1-724">Der Abruf der Speicherressourcennutzung eines bestimmten Standorts wird jetzt unterstützt, und das Hinzufügen einer Warnmeldung für den Abruf der globalen Speicherressourcennutzung ist überflüssig.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-724">Support get the Storage resource usage of a specific location, and add warning message for get global Storage resource usage is obsolete.</span></span>
    - <span data-ttu-id="2a4f1-725">Get-AzStorageUsage</span><span class="sxs-lookup"><span data-stu-id="2a4f1-725">Get-AzStorageUsage</span></span>
    
#### <a name="azcognitiveservices"></a><span data-ttu-id="2a4f1-726">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="2a4f1-726">Az.CognitiveServices</span></span>
* <span data-ttu-id="2a4f1-727">„Get-AzCognitiveServicesAccountSkus“ wird ohne vorhandenes Konto unterstützt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-727">Support Get-AzCognitiveServicesAccountSkus without an existing account.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="2a4f1-728">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="2a4f1-728">Az.Compute</span></span>
* <span data-ttu-id="2a4f1-729">Korrektur von „Get-AzVM -ResourceGroupName <rg>“, sodass ggf. mehr als 50 Ergebnisse zurückgegeben werden</span><span class="sxs-lookup"><span data-stu-id="2a4f1-729">Fix Get-AzVM -ResourceGroupName <rg> to return more than 50 results if needed</span></span>
* <span data-ttu-id="2a4f1-730">Der Cmdlet-Hilfe zu „New-AzVmss“ wurde ein Beispiel für „SimpleParameterSet“ hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-730">Added an example of the 'SimpleParameterSet' to New-AzVmss cmdlet help.</span></span>
* <span data-ttu-id="2a4f1-731">Tippfehler in der Azure Disk Encryption-Statusmeldung behoben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-731">Fixed a typo in the Azure Disk Encryption progress message</span></span>

#### <a name="azdatafactoryv2"></a><span data-ttu-id="2a4f1-732">Az.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="2a4f1-732">Az.DataFactoryV2</span></span>
* <span data-ttu-id="2a4f1-733">Die Version des ADF .Net-SDK wurde auf 2.3.0 aktualisiert.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-733">Updated the ADF .Net SDK version to 2.3.0.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="2a4f1-734">Az.Network</span><span class="sxs-lookup"><span data-stu-id="2a4f1-734">Az.Network</span></span>
* <span data-ttu-id="2a4f1-735">NetworkProfile-Funktionalität wurde hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-735">Added NetworkProfile functionality.</span></span> <span data-ttu-id="2a4f1-736">Neue Cmdlets hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-736">new cmdlets added</span></span>
    - <span data-ttu-id="2a4f1-737">Get-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="2a4f1-737">Get-AzNetworkProfile</span></span>
    - <span data-ttu-id="2a4f1-738">New-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="2a4f1-738">New-AzNetworkProfile</span></span>
    - <span data-ttu-id="2a4f1-739">Remove-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="2a4f1-739">Remove-AzNetworkProfile</span></span>
    - <span data-ttu-id="2a4f1-740">Set-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="2a4f1-740">Set-AzNetworkProfile</span></span>
    - <span data-ttu-id="2a4f1-741">New-AzContainerNicConfig</span><span class="sxs-lookup"><span data-stu-id="2a4f1-741">New-AzContainerNicConfig</span></span>
    - <span data-ttu-id="2a4f1-742">New-AzContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="2a4f1-742">New-AzContainerNicConfigIpConfig</span></span>
* <span data-ttu-id="2a4f1-743">Dienstzuordnungslink in Subnetzmodell hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-743">Added service association link on Subnet Model</span></span>
* <span data-ttu-id="2a4f1-744">Cmdlets New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-744">Added cmdlet New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span></span>
* <span data-ttu-id="2a4f1-745">Cmdlets Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-745">Added cmdlet Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span></span>

#### <a name="azrediscache"></a><span data-ttu-id="2a4f1-746">Az.RedisCache</span><span class="sxs-lookup"><span data-stu-id="2a4f1-746">Az.RedisCache</span></span>
* <span data-ttu-id="2a4f1-747">Künftig sind beliebige Zeichenfolgen als Größenparameter zulässig.</span><span class="sxs-lookup"><span data-stu-id="2a4f1-747">Allow any string as Size parameter going forward.</span></span> <span data-ttu-id="2a4f1-748">P5 in Popup „PSArgumentCompleter“ hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-748">Add P5 in PSArgumentCompleter popup</span></span>

#### <a name="azresources"></a><span data-ttu-id="2a4f1-749">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="2a4f1-749">Az.Resources</span></span>
* <span data-ttu-id="2a4f1-750">Fehlender Parameter „-Mode“ zu „Set-AzPolicyDefinition“ hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="2a4f1-750">Add missing -Mode parameter to Set-AzPolicyDefinition</span></span>
* <span data-ttu-id="2a4f1-751">Cmdlet-Fehler bei „Get-AzProviderOperation“ für Vorgänge mit Ursprung behoben, der den Benutzer enthält</span><span class="sxs-lookup"><span data-stu-id="2a4f1-751">Fix Get-AzProviderOperation commandlet bug for operations with Origin containing User</span></span>

#### <a name="azsql"></a><span data-ttu-id="2a4f1-752">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="2a4f1-752">Az.Sql</span></span>
* <span data-ttu-id="2a4f1-753">Problem behoben, aufgrund dessen einige Sicherungs-Cmdlets das aktuelle Azure-Abonnements nicht erkannt haben</span><span class="sxs-lookup"><span data-stu-id="2a4f1-753">Fixed issue where some backup cmdlets would not recognize the current azure subscription</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="2a4f1-754">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="2a4f1-754">Az.Websites</span></span>
* <span data-ttu-id="2a4f1-755">Neues Cmdlet „Get-AzWebAppContainerContinuousDeploymentUrl“ zum Abrufen der Webhook-URL von Continuous Deployment für Container</span><span class="sxs-lookup"><span data-stu-id="2a4f1-755">New Cmdlet Get-AzWebAppContainerContinuousDeploymentUrl - Gets the Container Continuous Deployment Webhook URL</span></span>
* <span data-ttu-id="2a4f1-756">Neue Cmdlets „New-AzWebAppContainerPSSession“ und „Enter-WebAppContainerPSSession“ zum Initiieren einer PowerShell-Remotesitzung in einer Windows-Container-App</span><span class="sxs-lookup"><span data-stu-id="2a4f1-756">New Cmdlets New-AzWebAppContainerPSSession and Enter-WebAppContainerPSSession  - Initiates a PowerShell remote session into a windows container app</span></span>

## <a name="020---september-2018"></a><span data-ttu-id="2a4f1-757">0.2.0 – September 2018</span><span class="sxs-lookup"><span data-stu-id="2a4f1-757">0.2.0 - September 2018</span></span>
 <span data-ttu-id="2a4f1-758">Erste Version</span><span class="sxs-lookup"><span data-stu-id="2a4f1-758">Initial Release</span></span>