...
In diesem Beispiel rufen wir eine Liste mit virtuellen Azure-Computern in unserem Standardabonnement ab.  Bei dem Befehl `Get-AzVM` erfolgt die Ausgabe standardmäßig in einem Tabellenformat.
