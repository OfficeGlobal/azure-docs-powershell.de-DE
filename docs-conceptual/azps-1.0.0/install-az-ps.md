...
Azure PowerShell kann mit PowerShell 5.x unter Windows 7 oder höher und mit PowerShell 6.x auf einer beliebigen Plattform verwendet werden.
...
Wenn Sie PowerShell 5.x unter Windows verwenden, muss auch .NET Framework 4.7.2 installiert sein. Eine Anleitung zur Aktualisierung oder Installation einer neuen Version von .NET Framework finden Sie im [.NET Framework-Installationsleitfaden](/dotnet/framework/install).
