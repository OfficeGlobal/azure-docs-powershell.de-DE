...
## <a name="create-a-service-principal"></a><span data-ttu-id="7044a-110">Erstellen eines Dienstprinzipals</span><span class="sxs-lookup"><span data-stu-id="7044a-110">Create a service principal</span></span>
